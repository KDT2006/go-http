...
func TestRequestLineParse(t *testing.T) {
	...
	// _, err = RequestFromReader(strings.NewReader("GET /hello HTTP/2\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	// require.Error(t, err)

	// // Test: Invalid HTTP method(out of order)
	// _, err = RequestFromReader(strings.NewReader("/endpoint  GET HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	// require.Error(t, err)
...
func TestParseBody(t *testing.T) {
	...
	// Test: Emmpty Body, no reported content length
	reader = &chunkReader{
		data: "POST /submit HTTP/1.1\r\n" +
			"Host: localhost:42069\r\n" +
			"\r\n",
